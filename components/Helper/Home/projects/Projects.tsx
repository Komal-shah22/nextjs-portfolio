    ...
    >
      ...
      <div className="bg-transparent p-4 rounded-b-lg">
        ...
        <div className="flex space-x-4 mt-3">
          <Link href={project.link} target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-500 transition duration-300">
            <FaEye size={24} />
          </Link>
          <Link href={project.github} target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-500 transition duration-300">
            <FaGithub size={24} />
          </Link>
        </div>
      </div>
    ...
    <div className="bg-black relative w-full flex items-center justify-center py-12">
      ...
      <div className="relative w-[90%] sm:w-[320px] h-[450px] flex justify-center">
        {projects.map((project, index) => {
          ...
          return <ProjectCard key={index} project={project} isActive={index === activeIndex} position={position} />;
        })}
      </div>
    </div>
  );
